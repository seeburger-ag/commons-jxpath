...
public class JXPathIntrospector {
	...
	private static Map<Class<?>, JXPathBeanInfo> byClass = new ConcurrentHashMap<Class<?>, JXPathBeanInfo>();
	private static Map<Class<?>, JXPathBasicBeanInfo> byInterface = new ConcurrentHashMap<Class<?>, JXPathBasicBeanInfo>();
